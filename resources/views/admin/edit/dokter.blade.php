        ...
        <div class="tw-max-w-7xl tw-mx-auto sm:tw-px-6 lg:tw-px-8">
            <div class="tw-bg-white tw-overflow-hidden tw-shadow-sm sm:tw-rounded-lg">
                <div class="tw-p-6 tw-text-gray-900">
                    <form action="{{ route('update.dokter', $dokter->id) }}" method="post" accept-charset="utf-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="tw-block tw-mt-1 tw-w-full" type="text"
                                name="name" :value="old('name', $dokter->name)" required autofocus autocomplete="name" />
                        ...
                        <div class="tw-mt-4">
                            ...
                            <x-text-input id="email" class="tw-block tw-mt-1 tw-w-full" type="email"
                                name="email" :value="old('email', $dokter->email)" required autocomplete="username" />
                        ...
                        <div class="tw-mt-4">
                            ...
                            <x-text-input id="username" class="tw-block tw-mt-1 tw-w-full" type="text"
                                name="username" :value="old('username', $dokter->username)" required autocomplete="username" />
                        ...
                        <div class="tw-flex tw-items-center tw-justify-end tw-mt-4">
                            <button class="ms-4 btn btn-info">
                                {{ __('Edit') }}
                            </button>
                        </div>
                    </form>
